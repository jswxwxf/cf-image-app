/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 1f4c3be7b3aa3d1bb9079c0b18150dc8)
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* image-app */;
	}
	interface Env {
		NEXTJS_ENV: string;
		IMAGE_APP_UPLOADS: R2Bucket;
		DB: D1Database;
		ANALYSIS_QUEUE: Queue;
		WORKER_SELF_REFERENCE: Fetcher /* image-app */ | Service<typeof import("./.open-next/worker").default>;
